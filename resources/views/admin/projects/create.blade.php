...
<div class="container py-5">
    ...
    <form action="{{ route('admin.projects.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputEmail1" name="name" value="{{old('name')}}" required>
            @error('title')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('used_technologies') is-invalid @enderror" id="exampleInputEmail1" name="used_technologies" value="{{old('used_technologies')}}" required>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('project_date') is-invalid @enderror" id="exampleInputEmail1" name="project_date" value="{{old('project_date')}}" required>
            @error('project_date')
            <div class="invalid-feedback">
                {{$message}}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('link_github') is-invalid @enderror" id="exampleInputEmail1" name="link_github" value="{{old('link_github')}}" required>
            @error('link_githube')
            <div class="invalid-feedback">
                {{$message}}
            </div>
